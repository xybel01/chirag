...
if (!isFirebaseConfigured) {
  ...
  seedMockCollection('assets', [
    { id: 'NPL-LT-0001', assetId: 'NPL-LT-0001', category: 'Laptop', subcategory: 'LT', deviceType: 'LAPTOP', manufacturer: 'Lenovo', model: 'ThinkPad T14', serialNumber: 'SN-T14-001', hostName: 'NPL-LT-0001', ram: '16 GB', storage: '512GB SSD', cpu: 'Intel Core i5', operatingSystem: 'Windows 11', condition: 'Good', status: 'AVAILABLE', location: 'Head Office', warrantyExpiry: '2028-07-15', purchasePrice: 1200 },
    { id: 'NPL-LT-0002', assetId: 'NPL-LT-0002', category: 'Laptop', subcategory: 'LT', deviceType: 'LAPTOP', manufacturer: 'Dell', model: 'Latitude 5430', serialNumber: 'SN-LAT-002', hostName: 'NPL-LT-0002', ram: '8 GB', storage: '256GB SSD', cpu: 'Intel Core i5', operatingSystem: 'Windows 11', condition: 'Good', status: 'AVAILABLE', location: 'Head Office', warrantyExpiry: '2026-07-28', purchasePrice: 950 },
    { id: 'NPL-DT-0001', assetId: 'NPL-DT-0001', category: 'Desktop', subcategory: 'DT', deviceType: 'DESKTOP', manufacturer: 'HP', model: 'ProDesk 400', serialNumber: 'SN-PRO-001', hostName: 'NPL-DT-0001', ram: '16 GB', storage: '512GB SSD', cpu: 'Intel Core i7', operatingSystem: 'Windows 11', condition: 'Good', status: 'AVAILABLE', location: 'Head Office', warrantyExpiry: '2026-05-10', purchasePrice: 850 },
